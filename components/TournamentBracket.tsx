...
export default function TournamentBracket() {
  ...
  const getTournamentWinner = () => {
    ...
    const winningPlayerId =
      final.player1Games > final.player2Games
        ? final.player1Id
        : final.player2Id;
  ...
  const thirdPlace = tournament.bracketMatches.find(
    ...
    <div className="space-y-8">
      ...
      {final && (
        <div>
          ...
          <div className="flex justify-center">{renderMatchCard(final)}</div>
          {winner && (
